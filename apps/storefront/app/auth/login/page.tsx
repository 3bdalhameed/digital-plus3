...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md card-purple p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-black text-primary-dark">تسجيل الدخول</h1>
          <p className="text-gray-500 text-sm mt-1">مرحباً بك مجدداً</p>
        </div>
