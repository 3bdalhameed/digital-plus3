        ...
        // ── 8. Store Features / Icons with Text ────────────────
        {
          ...
          fields: [
            ...
            },
            {
              ...
              fields: [
                { name: "title",         label: "العنوان (عربي)", type: "text",     required: true },
                { name: "titleEn",       label: "العنوان (إنجليزي)", type: "text", admin: { description: "اختياري. يظهر عند اختيار الزائر EN." } },
                { name: "description",   label: "الوصف (عربي)",   type: "textarea", required: true },
                { name: "descriptionEn", label: "الوصف (إنجليزي)", type: "textarea", admin: { description: "اختياري. يظهر عند اختيار الزائر EN." } },
          ...
          fields: [
            ...
            titleEnField,
            {
              ...
              fields: [
                ...
                { name: "label",   label: "التسمية (عربي)",         type: "text", required: true },
                { name: "labelEn", label: "التسمية (إنجليزي)",       type: "text", admin: { description: "اختياري. يظهر عند اختيار الزائر EN." } },
          ...
          fields: [
            ...
            },
            {
              ...
              fields: [
                ...
                { name: "text",   label: "الرأي (عربي)",       type: "textarea", required: true },
                { name: "textEn", label: "الرأي (إنجليزي)",    type: "textarea", admin: { description: "اختياري. يظهر عند اختيار الزائر EN." } },
        ...
        // ── 11. FAQ ────────────────────────────────────────────
        {
          ...
          fields: [
            ...
            titleEnField,
            {
              ...
              admin: { components: { RowLabel: ArrayRowLabel as any } },
              fields: [
                { name: "question",   label: "السؤال (عربي)",    type: "text",     required: true },
                { name: "questionEn", label: "السؤال (إنجليزي)", type: "text",     admin: { description: "اختياري. يظهر عند اختيار الزائر EN." } },
                { name: "answer",     label: "الجواب (عربي)",    type: "textarea", required: true },
                { name: "answerEn",   label: "الجواب (إنجليزي)", type: "textarea", admin: { description: "اختياري. يظهر عند اختيار الزائر EN." } },
              ],
            },
            ...layoutFields,
          ],
